...
public class PrincipalMysql {
    ...
    public static void main(String[] args) {
        String nombreBaseDatos = "empresa5"; //Tiene que estar creado primero con: CREATE DATABASE empresa5;
        ...
        if (numeroQuery == 1) {
            ...
            System.out.println("------------");
            BaseDatosMysql.setConexion(true, nombreBaseDatos);
            Connection conexion = BaseDatosMysql.getConexion();
            if (conexion != null) {
                System.out.println("OK CONEXION");
                createTable(conexion);
                BaseDatosMysql.setConexion(false, nombreBaseDatos);
            } else {
