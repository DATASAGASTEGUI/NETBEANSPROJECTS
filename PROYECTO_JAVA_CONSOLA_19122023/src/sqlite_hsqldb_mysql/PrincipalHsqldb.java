...
public class PrincipalHsqldb {

    public static void main(String[] args) {
        String nombreBaseDatos = "data/sqlite_hsqldb_mysql/empresa/empresa.hsqldb"; //Ruta Relativa
        ...
        if (numeroQuery == 1) {
            ...
            System.out.println("------------");
            BaseDatosHsqldb.setConexion(true, nra);
            Connection conexion = BaseDatosHsqldb.getConexion();
            if (conexion != null) {
                System.out.println("OK CONEXION");
                createTable(conexion);
                BaseDatosHsqldb.setConexion(false, nra);
            } else {
