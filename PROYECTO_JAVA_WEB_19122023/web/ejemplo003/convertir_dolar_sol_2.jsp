...
<html>
    ...
    <body>
        <div style="text-align: center">
            ...
            %>
            <!-- VISTA (HTML)-->
            <form action="convertir_dolar_sol_2.jsp" method="post">
                <!-- ENTRADA -->
                <p>
                    <label for="lblDolar">DOLAR</label><br/>
                    <input type="number" id="lblDolar" name="txtDolar" value="<%=dolar%>" min="0" max="99999999" step="any" placeholder="ESCRIBIR AQUI" title="ENTRADA" style="background-color: green; border: none;" />
                </p>
                <!-- SALIDA -->
                <p>
