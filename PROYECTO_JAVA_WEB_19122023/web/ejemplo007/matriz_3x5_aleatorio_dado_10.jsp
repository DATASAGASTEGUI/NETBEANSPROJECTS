...
<html>
    ...
    <body>
        ...
        <div style="text-align: center">
            ...
            <%
                out.print("<form action='matriz_3x5_aleatorio_dado_10.jsp' method='post'>");
                //ENTRADA
                for (int i = 0; i < matriz.length; i++) {
                    for (int j = 0; j < matriz[i].length; j++) {
                        ...
                        out.print("<input class='input_text_1' type='text' name='matriz[" + i + "][" + j + "]' value='" + matriz[i][j] + "' title='ENTRADA' />");
                    }
                    out.print("<br/>");
                }
                out.print("<br/>");
